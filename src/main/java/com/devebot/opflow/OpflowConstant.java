...
public class OpflowConstant {
    ...
    public final static String COMP_CONNECTORS = "connectors";
    ...
    public final static String OPFLOW_COMMON_PORT = "port";
    ...
    public final static String OPFLOW_COMMON_OS_INFO = "OS";
    public final static String OPFLOW_COMMON_CPU_USAGE = "cpuUsage";
