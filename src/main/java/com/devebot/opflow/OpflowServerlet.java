                            ...
                            returnValue = new OpflowRpcChecker.Pong(OpflowObjectTree.buildMap(new OpflowObjectTree.Listener<Object>() {
                                ...
                                public void transform(Map<String, Object> opts) {
                                    ...
                                    opts.put(CONST.COMPNAME_RPC_WORKER, OpflowObjectTree.buildMap()
                                            ...
                                            .put(OpflowConstant.OPFLOW_PRODUCING_EXCHANGE_NAME, engine.getExchangeName())
                                            .put(OpflowConstant.OPFLOW_PRODUCING_ROUTING_KEY, engine.getRoutingKey())
                                            .put(OpflowConstant.OPFLOW_CONSUMING_BINDING_KEYS, engine.getOtherKeys())
